...
public class PredicateSpeed extends Application {
	...
	void setPredicate ( String filterText ) {
		...
		filteredContent.setPredicate( ( Person person ) -> {
			...
			//So o finds Ã¶ and Ã³, a finds Ä�, etc.
			matchableText.add( 
	...
	String[] firstNames = new String[] {
		...
		"ALPHONSE","ALPHONSO","ALTON","ALVA","ALVARO","ALVIN","AMADO","AMBRÃ³SE","AMOS","ANDERSON",
	...
	String[] lastNames = new String[] {
		...
		"EVANS","TURNER","TORRES","PARKER","CÃ³LLINS","EDWARDS","STEWÄ�RT","FLORES","MORRIS",
		...
		"MURRAY","FORD","MARSHALL","OWENS","MCDONALD","HÄ�RRISON","RUIZ","KENNEDY","WELLS",
		...
		"PETERS","HAWKINS","GRANT","HANSEN","CASTRÃ³","HOFFMAN","HART","ELLIOTT","CUNNINGHAM",
		...
		"GREENE","BURKE","GUZMAN","MORRISON","MUNOZ","JACOBS","Ã³BRIEN","LAWSON","FRANKLIN","LYNCH",
		...
		"SANTOS","CURTIS","PEARSON","DELGADO","VALDEZ","PENA","RIOS","DOUGLAS","SANDOVAL","BÄ�RETT",
	...
	String[] streetNames = new String[] {
		...
		"HALE","LYONS","GRAVES","HAYNES","MILES","PARK","WARNER","PÄ�DILLA","BUSH","THORNTON",
		"MCCARTHY","MANN","ZIMMERMAN","ERICKSON","FLETCHER","MCKINNEY","PAGE","DAWSON","JOSEPH",
		"MARQUEZ","REEVES","KLEIN","ESPINÃ³ZA","BALDWIN","MORAN","LOVE","ROBBINS","HIGGINS","BALL",
		"CORTEZ","LE","GRIFFITH","BOWEN","SHARP","CUMMINGS","RAMSEY","HARDY","SWANSON","BARBER",
		"ACOSTA","LUNA","CHÄ�NDLER","DANIEL","BLAIR","CROSS","SIMON","DENNIS","OCONNOR","QUINN",
		"GROSS","NAVARRO","MÃ³SS","FITZGERALD","DOYLE","MCLAUGHLIN","ROJAS","RODGERS","STEVENSON",
		"SINGH","YANG","FIGUEROA","HARMON","NEWTON","PAUL","MANNING","GARNER","MCGEE","REESE",
		"FRANCIS","BURGESS","ADKINS","GOODMAN","CURRY","BRADY","CHRISTENSEN","POTTER","WÄ�LTON",
