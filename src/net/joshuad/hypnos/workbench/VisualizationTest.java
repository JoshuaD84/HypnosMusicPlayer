...
import net.joshuad.hypnos.workbench.VlcjTest;
 ...
 * want, and hit "Play".
 */
public class VisualizationTest extends VlcjTest {
    ...
    public static void main(final String[] args) throws Exception {
		...
		*/
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new VisualizationTest("D:\\test\\2.mp3").start();
            }
        });
    }

    public VisualizationTest(String mrl) {
        this.mrl = mrl;
    ...
    private void doPlay() {
        String[] options = {"audio-visual=visual", "effect-list=" + comboBox.getSelectedItem(), "effect-width=" + 100, "effect-height=" + 100};
