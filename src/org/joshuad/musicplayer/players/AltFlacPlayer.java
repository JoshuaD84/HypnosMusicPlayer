...
public final class AltFlacPlayer extends AbstractPlayer implements Runnable {
	...
	public AltFlacPlayer ( Track track, Slider trackPositionSlider, boolean startPaused ) throws IOException, LineUnavailableException {
		this.track = track;
	...
	public AltFlacPlayer ( Track track, Slider trackPositionSlider ) throws IOException, LineUnavailableException {
