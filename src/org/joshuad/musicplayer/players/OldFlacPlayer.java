...
public final class OldFlacPlayer extends AbstractPlayer implements Runnable {
	...
	public OldFlacPlayer ( Track track, Slider trackPositionSlider, boolean startPaused ) {
		this.track = track;
	...
	public OldFlacPlayer ( Track track, Slider trackPositionSlider ) {
